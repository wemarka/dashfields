  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-[#ef3735] focus-visible:ring-[#ef3735]/40 focus-visible:ring-[3px]",
        "aria-invalid:border-[#ef3735] aria-invalid:ring-[#ef3735]/40 aria-invalid:ring-[3px]",
        className
      )}
      onCompositionStart={handleCompositionStart}
      onCompositionEnd={handleCompositionEnd}
