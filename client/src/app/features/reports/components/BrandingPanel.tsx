        ...
        <div className="px-5 pb-5 border-t border-border pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input value={branding.accentColor} onChange={e => onChange({ ...branding, accentColor: e.target.value })} placeholder="#ef3735" className="flex-1 px-3 py-2 rounded-xl border border-border bg-background text-sm font-mono focus:outline-none focus:ring-2 focus:ring-primary/30" />
            </div>
          </div>
